...
export function findBestMatch(text) {
    ...
    // 각 점수에 해당하는 키워드 목록
    const KEYWORDS = [
        { value: 0, keywords: ["전혀", "아니", "없", "1번", "하나", "일번", "일", "그렇지 않다"] },            // 0점: 전혀 그렇지 않다
        { value: 1, keywords: ["약간", "조금", "가끔", "2번", "둘", "이번", "이"] },            // 1점: 약간 그렇다
        { value: 2, keywords: ["꽤", "종종", "자주", "많", "3번", "셋", "삼번", "깨", "삼"] },        // 2점: 꽤 그렇다
        { value: 3, keywords: ["매우", "항상", "심", "굉장", "4번", "넷", "사번", "매일", "사"] } // 3점: 매우 그렇다
    ];
